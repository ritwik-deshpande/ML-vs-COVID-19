...
def trainModel():
	...
	with open('my_encodings.pkl', 'wb') as eid:

		pickle.dump(encodings, eid)
...
def predict(gender,age,notes,detected_state,symptoms,diagnosed_date):
	...
	with open('my_encodings.pkl', 'rb') as eid:
		encodings = pickle.load(eid)
...
if __name__ == '__main__':
	...
	print("Enter your Travel History or patient you have come in contact with\n")
	notes = input()

	print("Enter the name of State you live in\n")
	state = input()

	print("Enter your Symptoms\n")
	symptoms = input()

	print("Enter the date you started feeling unwell (DD/MM/YYY)\n")
	d = input()

	ans = str(predict(gender,age,notes,state,symptoms,d)[0])
	print(ans)

	print('The patient belongs to the Category')
	if ans == '2.0' or ans =='2':
		print('Suspected')

	elif ans == '1.0' or ans =='1':
		print('High Risk')
	else:
		print('Safe')
